...
class App {
  ...
  middlewares() {
    ...
    this.server.use('/v1/dex/api', limiter) ;
    this.server.use('/v1/dex/admin/api', limiter) ;
  }

  routes() {
    this.server.use('/v1/dex/api', userRoutes) ;
    this.server.use('/v1/dex/admin/api', adminRoutes) ;
    this.server.use('/v1/dex/files', express.static('./src/uploads'));
