...
import { DeleteNotification, NotificationList } from '../../../../redux/actions/ex/notification';
...
const mapStateToProps = state => ({
    notificationList : state.ex.notification.notificationList
})
